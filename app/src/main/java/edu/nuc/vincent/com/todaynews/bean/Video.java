...
public class Video {
    ...
    public static class DataBean {
         ...
         * mediaType : null
         * memberOnly : null
         * title : #游戏#当#王者荣耀#和#阴阳师#一起会发生什么ο(=•ω＜=)ρ⌒☆
         * posterScreenName : 零小度lingdu
         * id : 999132469
         * catPathKey : null
         * dislikeCount : null
         * commentCount : 13
